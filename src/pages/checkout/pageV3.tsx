...
export default function CheckoutPageV3() {
  ...
  const pixDiscount = navState?.paymentMethod === 'pix' ? subtotal * 0.1 : 0;
  const total = subtotal + shippingData.cost - couponDiscount - pixDiscount;

  if (loading) {
    return (
      <>
        <SEOHead
          title="Checkout V3 - Sempre Bella Balsas"
          description="Pague com Mercado Pago diretamente do carrinho (teste)."
          noIndex={true}
        />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-8">
            ...
            <i className="ri-arrow-right-s-line"></i>
            <span className="text-gray-900 font-medium">Checkout V3</span>
          </nav>
