      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-2 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-14 py-8">
          <div className="flex flex-col md:flex-row gap-4">
            <aside className="hidden md:block md:w-64 flex-shrink-0 md:ml-4 lg:ml-6 xl:ml-8 2xl:ml-10">
            ...
            <main className="flex-1">
              {/* Filtro de Tamanhos - Mobile (horizontal) */}
              <div className="block md:hidden mb-4 -mx-2 px-2" aria-label="Filtro de tamanhos">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-sm font-semibold text-gray-700">Tamanhos</h4>
                  {filtroTamanho.length > 0 && (
                    <button
                ...
                <div className="flex gap-2 overflow-x-auto scroll-smooth" role="listbox" aria-orientation="horizontal">
                  {tamanhos.length === 0 ? (
                    ...
                    tamanhos.map((tamanho) => {
                      const selected = filtroTamanho.includes(tamanho);
                      return (
                        <button
                          key={tamanho}
